...
StyledRect {
    ...
    property bool showScrollButtons: false
    ...
    function scrollToActiveTab(): void {
        ...
        Qt.callLater(() => {
            ...
            const currentIndex = root.tabs.findIndex(tab => tab.id === root.activeTab);
            if (currentIndex === -1)
                return;
            ...
            const activeTabItem = tabsRow.children[currentIndex];
            if (!activeTabItem)
                return;

            const tabWidth = activeTabItem.width;
    ...
    RowLayout {
        ...
        Item {
            ...
            StyledFlickable {
                ...
                Item {
                    ...
                    StyledRect {
                        ...
                        x: activeTabItem ? activeTabItem.x : 0
                        y: activeTabItem ? activeTabItem.y : 0
                        width: activeTabItem ? activeTabItem.width : 0
                        height: activeTabItem ? activeTabItem.height : 0
            ...
            Item {
                ...
                StyledRect {
                    id: activeIndicatorSimple

                    property Item activeTabItem: {
                        for (let i = 0; i < tabsRepeaterSimple.count; i++) {
                            const tab = tabsRepeaterSimple.itemAt(i);
                            if (tab && tab.isActive) {
                                return tab;
                            }
                        }
                ...
                Row {
                    ...
                    Repeater {
                        ...
                        delegate: Item {
                            ...
                            implicitWidth: tabContentSimple.width + Appearance.padding.normal * 2
                            implicitHeight: tabContentSimple.height + Appearance.padding.smaller * 2

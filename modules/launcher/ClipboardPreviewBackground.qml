...
ShapePath {
    ...
    PathArc {
        ...
        relativeY: clipboardPreview.height > root.rounding ? -root.rounding : -clipboardPreview.height
    ...
    PathLine {
        relativeX: 0
        relativeY: clipboardPreview.height > root.rounding * 2 ? -(root.clipboardPreview.height - root.rounding * 2) : 0
    }

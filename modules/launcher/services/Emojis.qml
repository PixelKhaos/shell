...
Singleton {
    ...
    function search(query: string): var {
        ...
        return root.emojis.filter(emoji => {
            ...
            if (emoji.keywords && emoji.keywords.some(k => k.toLowerCase().includes(lowerQuery))) return true;
            return false;
        });
    }

...
<<<<<<< HEAD
    ...
    // Property to track pending provider switch
...
<<<<<<< HEAD
                // Disconnect completed, now switch provider
...
<<<<<<< HEAD
                ...
                // Connect to the new provider after a brief delay
...
<<<<<<< HEAD
        StyledRect {
            ...
            color: Qt.alpha(Colours.tPalette.m3surfaceContainer, root.session.vpn.active === modelData ? Colours.tPalette.m3surfaceContainer.a : 0)
                ...
                StyledRect {
                    ...
                    StateLayer {
                        ...
                        function onClicked(): void {
                            ...
                            if (modelData.enabled) {
                                // Already enabled - just toggle connection
                                VPN.toggle();
                            } else {
                                // Not enabled - need to switch providers
                                if (VPN.connected) {
                                    // Set pending switch and disconnect
                                    // The Connections handler will complete the switch when disconnected
                                    root.pendingSwitchIndex = clickedIndex;
                                    VPN.toggle();
                                } else {
